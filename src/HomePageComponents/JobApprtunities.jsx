    ...
    return (
        (isLoading) ?
            ...
            <div className='job-apprtunities position-relative'>
                <span className="position-absolute job-apprtunities-tag" data-aos="fade-left" data-aos-delay="400" data-aos-duration="800">
                            ...
                            jobApprtunities.map(item => (
                                <SwiperSlide>
                                    <Row>
                                        {
                                            item.map(details => (
                                                <Col lg={6} md={12} sm={12} className='p-4 job-apprtunity-container' data-aos="zoom-in-up" data-aos-delay="500" data-aos-duration="500" data-aos-easing="linear">
                                                    <div className='d-flex job-apprtunity flex-wrap'>
                                                        <div>
